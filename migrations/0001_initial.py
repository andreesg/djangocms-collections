...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'RichCollection'
        db.create_table(u'rich_collection_richcollection', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('public_extension', self.gf('django.db.models.fields.related.OneToOneField')(related_name='draft_extension', unique=True, null=True, to=orm['rich_collection.RichCollection'])),
        ...
        db.send_create_signal(u'rich_collection', ['RichCollection'])


    def backwards(self, orm):
        # Deleting model 'RichCollection'
        db.delete_table(u'rich_collection_richcollection')
